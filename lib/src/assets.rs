...
#[derive(Clone, Default, Resource)]
pub struct Images {
    pub board_line_thin_circle: Handle<Image>,
    ...
    pub pop_dark_circle: Handle<Image>,
...
impl Images {
    pub fn load(mut images: ResMut<Assets<Image>>) -> Self {
        Self {
            board_line_thin_circle: images.add(load_png(BOARD_LINE_THIN_CIRCLE)),
            ...
            pop_dark_circle: images.add(load_png(POP_DARK_CIRCLE)),

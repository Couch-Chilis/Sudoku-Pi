...
pub const COLOR_MAIN_DARKER: Color = Color::rgb(139. / 255., 126. / 255., 45. / 255.);
...
pub const COLOR_POP_DARK: Color = Color::rgb(213. / 255., 11. / 255., 72. / 255.);
pub const COLOR_POP_FOCUS: Color = Color::rgb(245. / 255., 55. / 255., 112. / 255.);
